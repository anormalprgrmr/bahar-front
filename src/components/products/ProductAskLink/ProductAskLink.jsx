 ...
 * }} props
 */
export function ProductAskLink({
  productName,
  className = '',
  iconOnly = false,
  withIcon = false,
  ...
  const content = iconOnly ? (
    ...
    <>
      <InstagramIcon />
      <span>هنوز مطمئن نیستی؟ ازم بپرس.</span>
    </>
  ) : (
  ...
  return (
    <a
      href={INSTAGRAM_URL}
      className={`${iconOnly ? styles.iconLink : withIcon ? styles.linkWithIcon : styles.link} ${className}`.trim()}
      target="_blank"
